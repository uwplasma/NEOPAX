# Completed database reverse 16/4 performance run — 2026-09-12

Source: user attachment `ad2267de-488a-4836-bc6d-8aa7a928b6a1/pasted-text.txt`.
The pasted header is malformed; the time footer records the executed command.
Compiler-label ownership is not inferred from adjacency. Original text follows.

```text
git pull --ff-only origin en/reverse_ad_improvement &&
...
python ./examples/benchmarks/benchmark_transport_reverse_ad_only.py \
  ...
  --reverse-schedule-artifact-mode reuse_static_probeupar_only \
From https://github.com/uwplasma/NEOPAX
 * branch            en/reverse_ad_improvement -> FETCH_HEAD
Already up to date.
[NEOPAX] built runtime NTX scan database: rho=7 nu_v=16 Er_tilde=11 grid=(25,31,64) backend=vmec
[autodiff-gate] progress: realtime geometry runtime build ready elapsed_s=628.126
[autodiff-gate] progress: realtime geometry solver components ready elapsed_s=0.654
...
E0912 18:19:50.685294    4566 slow_operation_alarm.cc:73]
********************************
...
********************************
E0912 18:20:08.649238    4524 slow_operation_alarm.cc:140] The operation took 2m17.96415602s

********************************
[Compiling module jit_scan for GPU] Very slow compile? If you want to file a bug, run with envvar XLA_FLAGS=--xla_dump_to=/tmp/foo and attach the results.
********************************
[autodiff-gate] progress: support reverse profile-state vjp ready elapsed_s=108.166
[autodiff-gate] progress: support reverse initial carry vjp ready elapsed_s=0.931
...
[autodiff-gate] progress: support reverse realized-schedule vjp forward ready elapsed_s=1.919
[autodiff-gate] progress: support reverse final-objective cotangents ready elapsed_s=286.341 ordinary_mode=grouped_vjp bootstrap_mode=joint_local_vjp_upar_only
...
[autodiff-gate] progress: support reverse segment 4/4 ready elapsed_s=1009.543 active_steps=4 support_reuse=0 support_rebuild=4
[autodiff-gate] progress: support reverse segment 3/4 ready elapsed_s=22.364 active_steps=4 support_reuse=0 support_rebuild=4
[autodiff-gate] progress: support reverse segment 2/4 ready elapsed_s=22.391 active_steps=4 support_reuse=0 support_rebuild=4
[autodiff-gate] progress: support reverse segment 1/4 ready elapsed_s=22.037 active_steps=4 support_reuse=0 support_rebuild=4
[autodiff-gate] progress: support reverse segmented cotangent sweep ready elapsed_s=1076.337 support_reuse=0 support_rebuild=16
[autodiff-gate] progress: support reverse reduced carry bars expanded ready elapsed_s=0.693
E0912 18:49:52.109353    4566 slow_operation_alarm.cc:73]
********************************
...
********************************
E0912 18:54:02.142081    4524 slow_operation_alarm.cc:140] The operation took 6m10.032824865s

********************************
[Compiling module jit__pullback for GPU] Very slow compile? If you want to file a bug, run with envvar XLA_FLAGS=--xla_dump_to=/tmp/foo and attach the results.
********************************
[autodiff-gate] progress: support reverse initial direct-RHS support pullback ready elapsed_s=568.883 boundary=database_split
[autodiff-gate] progress: support reverse initial state pullback ready elapsed_s=156.957
[autodiff-gate] progress: initial-Er root boundary compact pullback ready elapsed_s=265.768
[autodiff-gate] progress: support reverse profile parameter pullback ready elapsed_s=1.063
[autodiff-gate] progress: support reverse initial-profile scan payload pullback ready elapsed_s=1.562
FLAGS=--xla_dump_to=/tmp/foo and attach the results.
********************************
E0912 19:05:04.157480  103513 slow_operation_alarm.cc:140] The operation took 2m24.512548761s

********************************
[Compiling module jit__direct_cotangents for GPU] Very slow compile? If you want to file a bug, run with envvar XLA_FLAGS=--xla_dump_to=/tmp/foo and attach the results.
********************************
[autodiff-gate] progress: database final recorded-scan fold ready elapsed_s=707.702 objective_rows=10 groups=1 contract=one_batched_scan_transpose
...
[geometry-fd-ad] progress: objective_table vmec implicit state/raw-block aux ready elapsed_s=0.009
[geometry-fd-ad] progress: objective_table booz input tables ready elapsed_s=1.767
[geometry-fd-ad] progress: objective_table booz_xform vjp ready elapsed_s=7.520
[geometry-fd-ad] progress: objective_table vmec objective cotangents ready elapsed_s=16.327
[geometry-fd-ad] progress: objective_table DMerc softmax cotangent ready elapsed_s=11.926
[geometry-fd-ad] progress: objective_table boozer light cotangents ready elapsed_s=2.502
[geometry-fd-ad] progress: objective_table aspect proxy cotangents ready elapsed_s=0.089
[geometry-fd-ad] progress: objective_table j-qi/maxj Boozer cotangents ready elapsed_s=31.715
[geometry-fd-ad] progress: objective_table booz cotangents pulled to state elapsed_s=6.601
[geometry-fd-ad] progress: objective_table final vmec parameter pullback ready elapsed_s=41.566
[autodiff-gate] mode=transport_reverse_ad_only_full_transport_shared_payload_smoke objective=all residual_count=17 parameter_count=8 elapsed_s=3776.534
[autodiff-gate] optimization API residuals/Jacobian rows:
  - transport:softmax_Er: residual=2.1347597245906741e+01
      ...
      dtransport:softmax_Er/dvmec:RBC:1:0: jac=-2.7683707281136634e+01
      dtransport:softmax_Er/dvmec:ZBS:1:0: jac=6.3556954390710576e+00
  ...
  - transport:Er_transition_left: residual=1.7902257301111909e+01
      ...
      dtransport:Er_transition_left/dvmec:RBC:1:0: jac=-1.3445891807357173e+01
      dtransport:Er_transition_left/dvmec:ZBS:1:0: jac=-8.6697187673723708e-01
  - transport:Er_transition_right: residual=1.8666769949428140e+01
      ...
      dtransport:Er_transition_right/dvmec:RBC:1:0: jac=-1.5274580237777837e+01
      dtransport:Er_transition_right/dvmec:ZBS:1:0: jac=-5.0636952455206419e-01
  - transport:Er2_volume_average: residual=2.6970444513292227e+02
      ...
      dtransport:Er2_volume_average/dvmec:ZBS:1:0: jac=-3.3046442994759883e+02
  - transport:Er_volume_average: residual=-2.8511644406025951e+00
      ...
      dtransport:Er_volume_average/dvmec:RBC:1:0: jac=-6.8360480192986506e+00
      dtransport:Er_volume_average/dvmec:ZBS:1:0: jac=1.4302240534246733e+01
  ...
  - transport:bootstrap_current_softmax_abs_scaled: residual=1.3717342708882792e+00
      ...
      dtransport:bootstrap_current_softmax_abs_scaled/dvmec:ZBS:1:0: jac=-1.2135493890455435e+00
  - geometry:boozer_qi_objective: residual=2.1192029964274445e-01
      ...
      dgeometry:boozer_qi_objective/dvmec:RBC:1:0: jac=5.9392891187040391e+00
      dgeometry:boozer_qi_objective/dvmec:ZBS:1:0: jac=-1.2365550093568345e-01
  - geometry:boozer_maxj_objective: residual=4.4387332574094023e+02
      ...
      dgeometry:boozer_maxj_objective/dvmec:RBC:1:0: jac=-3.8431351876830449e+03
      dgeometry:boozer_maxj_objective/dvmec:ZBS:1:0: jac=-1.9205082804617996e+03
...
Wrote outputs/autodiff_transport_lagged_ntx/reverse_ad/transport_reverse_ad_only_full_transport_shared_payload_smoke.json
	...
	User time (seconds): 5387.23
	System time (seconds): 279.79
	...
	Maximum resident set size (kbytes): 14486496
	Average resident set size (kbytes): 0
	Major (requiring I/O) page faults: 1794
	Minor (reclaiming a frame) page faults: 19163602
	Voluntary context switches: 7209814
	Involuntary context switches: 506523
	Swaps: 0
	File system inputs: 2824656
	File system outputs: 606072

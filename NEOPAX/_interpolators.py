...
def interpolator_nu_Er_general_NTSS(index,grid_nu,grid_Er,database):
    x11=jnp.select(condlist=[(grid_Er<=database.Er_lower_limit_log) & (grid_nu < database.nu_log[0]),
                                (grid_Er<=database.Er_lower_limit_log) & ((grid_nu >= database.nu_log[0]) & (grid_nu <= database.nu_log[-1])),
                                (grid_Er<=database.Er_lower_limit_log) & (grid_nu > database.nu_log[-1]),
                                (grid_Er>database.Er_lower_limit_log) & (grid_nu < database.nu_log[0]),
                                (grid_Er>database.Er_lower_limit_log) & ((grid_nu >= database.nu_log[0]) & (grid_nu <= database.nu_log[1])),
                                (grid_Er>database.Er_lower_limit_log) & ((grid_nu >= database.nu_log[-2]) & (grid_nu <= database.nu_log[-1])),
                                (grid_Er>database.Er_lower_limit_log) & ((grid_nu > database.nu_log[1]) & (grid_nu < database.nu_log[-2])),
                                (grid_Er>database.Er_lower_limit_log) & (grid_nu > database.nu_log[-1])
                                ],
                      choicelist=[interpolator_nu_low_Er0(index,grid_nu,database),
                                  interpolator_nu_mid_Er0(index,grid_nu,database),
                                  interpolator_nu_large_Er0(index,grid_nu,database),
                                  interpolator_nu_low_Er_finite(index,grid_nu,grid_Er,database),
                                  interpolator_nu_mid_Er_finite_npoints3_low(index,grid_nu,grid_Er,database),
                                  interpolator_nu_mid_Er_finite_npoints3_high(index,grid_nu,grid_Er,database),
                                  interpolator_nu_mid_Er_finite_npoints4(index,grid_nu,grid_Er,database),
                                  interpolator_nu_large_Er_finite(index,grid_nu,grid_Er,database)],default=0)

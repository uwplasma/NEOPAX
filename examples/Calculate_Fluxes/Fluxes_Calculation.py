...
Output_Path=os.path.join(current_path,'./examples/Calculate_Fluxes/')
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'densities.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'temperatures.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'Electric_field.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L11e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L12e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L21e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L22e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L31e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L32e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L33e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L11D.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L12D.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L21D.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L22D.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L31D.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L32D.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L11T.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L12T.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L21T.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L22T.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L31T.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'L32T.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'J_Bootstrap.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'J_Bootstrap_e.pdf'))
...
plt.legend()
plt.savefig(os.path.join(Output_Path,'J_Bootstrap_Ion.pdf'))

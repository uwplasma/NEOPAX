...
One run can compare:
- database baseline
- exact-runtime with interpolate_from_faces
- exact-runtime with center_local_response
...
DEFAULT_CENTER_MODES = ["interpolate_from_faces", "center_local_response"]
...
def main():
    ...
    parser.add_argument(
        "--center-response-modes",
        nargs="+",
        default=DEFAULT_CENTER_MODES,
        choices=["interpolate_from_faces", "center_local_response"],
    ...
    print(f"[flux-compare] center_response_modes={args.center_response_modes}")
    ...
    for center_mode in args.center_response_modes:

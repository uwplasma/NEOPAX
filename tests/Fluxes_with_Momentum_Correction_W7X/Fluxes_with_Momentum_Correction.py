...
vmec_file=os.path.join(current_path,'../inputs/wout_W7-X_standard_configuration.nc')
boozer_file=os.path.join(current_path, '../inputs/boozmn_wout_W7-X_standard_configuration.nc')
